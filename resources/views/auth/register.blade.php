...
<body class="bg-light-gray" id="body">
    <div class="container d-flex flex-column justify-content-between vh-100">
                    ...
                    <div class="card-header bg-primary">
                        <div class="app-brand">
                            <a href="/index.html">
                                ...
                                <span class="brand-name">Belajar Laravel</span>
                            </a>
                        </div>
                    </div>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12 mb-4">
                                    <input type="text" name="name" :value="old('name')" required autofocus autocomplete="name" class="form-control input-lg" aria-describedby="nameHelp" placeholder="Name">
                                </div>
                                <div class="form-group col-md-12 mb-4">
        ...
        <div class="copyright pl-0">
            <p class="text-center">&copy; 2021 Copyright Belajar Laravel by
                <a class="text-primary" href="http://www.iamabdus.com/" target="_blank">Muhammad Aditya</a>.
            </p>
        </div>
    </div>
</body>
